        ...
        <div className="p-8 lg:p-10">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="relative group mx-auto lg:mx-0">
              {imageUrl ? (
                <div className="relative w-36 h-36 rounded-2xl overflow-hidden ring-4 ring-slate-100">
                  <Image src={imageUrl} alt="Foto" fill className="object-cover" />
                </div>
              ) : (
                <div className="w-36 h-36 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center ring-4 ring-slate-100">
                  {profile.rol === "jugador" ? (
                    <UserCircle2 size={72} className="text-slate-400" />
                  ) : (
                    <Users size={72} className="text-slate-400" />
                  )}
                </div>
              )}
              
              {editMode && (
                <label className="absolute bottom-2 right-2 bg-emerald-600 hover:bg-emerald-700 p-2.5 rounded-xl cursor-pointer shadow-lg transition-colors">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="mb-4">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
                  <span className="inline-flex items-center px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg text-sm font-semibold border border-emerald-200">
                    {profile.rol === "jugador" ? "⚽ Jugador" : "🏆 Club"}
                  </span>
                  {profile.rol === "jugador" && profile.posicion && (
                    <span className="inline-flex items-center px-3 py-1.5 bg-slate-100 text-slate-700 rounded-lg text-sm font-semibold">
                      {profile.posicion}
                    </span>
                  )}
              ...
              <div className="flex gap-3 justify-center lg:justify-start">
                {editMode && (
                  <button
                    ...
                    className="inline-flex items-center space-x-2 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-medium transition-all"
                  >
                    <X size={18} />
                    <span>Cancelar</span>
                  </button>
                ...
                <button
                  ...
                  disabled={submitting}
                  className={`inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl font-medium transition-all shadow-sm ${
                    editMode
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-slate-200 bg-slate-50">
            {profile.edad && (
              <div className="p-5 text-center border-r border-slate-200">
                <p className="text-3xl font-bold text-slate-900 mb-1">{profile.edad}</p>
                <p className="text-sm text-slate-600 font-medium">Años</p>
              </div>
            )}
            {profile.altura && (
              <div className="p-5 text-center border-r border-slate-200">
                <p className="text-3xl font-bold text-slate-900 mb-1">{profile.altura}</p>
                <p className="text-sm text-slate-600 font-medium">cm</p>
              </div>
            )}
            {profile.peso && (
              <div className="p-5 text-center border-r border-slate-200">
                <p className="text-3xl font-bold text-slate-900 mb-1">{profile.peso}</p>
                <p className="text-sm text-slate-600 font-medium">kg</p>
              </div>
            )}
            {profile.pierna && (
              <div className="p-5 text-center">
                <p className="text-3xl font-bold text-slate-900 mb-1 capitalize">{profile.pierna.charAt(0)}</p>
                <p className="text-sm text-slate-600 font-medium">Pierna {profile.pierna}</p>
              </div>
            )}
          </div>
        )}
        ...
        {profile.rol === "jugador" ? (
          <>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  {editMode ? (
                    <input
                      ...
                      required
                      className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                    />
                  ) : (
                    <p className="text-slate-900 font-medium text-lg">{profile.nombre_completo}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    {editMode ? (
                      ...
                      <p className="text-slate-900 font-medium text-lg">{profile.edad} años</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {editMode ? (
                      ...
                      <p className="text-slate-900 font-medium text-lg">{profile.posicion}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg">{profile.telefono || "No especificado"}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg">{profile.ubicacion || "No especificada"}</p>
                  )}
                  {editMode && (
                    <p className="text-xs text-slate-500 mt-1">💡 Escribe la comuna tal como la conoces (se normalizará automáticamente)</p>
                  )}
                </div>
              </div>
            </div>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    {editMode ? (
                      ...
                      <p className="text-slate-900 font-medium text-lg">{profile.altura} cm</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {editMode ? (
                      ...
                      <p className="text-slate-900 font-medium text-lg">{profile.peso} kg</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg capitalize">{profile.pierna}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:col-span-2">
              <h2 className="text-lg font-bold text-slate-900 mb-4">Experiencia</h2>
              {editMode ? (
                <textarea
                  value={experiencia}
                ...
                <p className="text-slate-700 leading-relaxed">{profile.experiencia || "No especificada"}</p>
              )}
            </div>

            {/* Disponibilidad */}
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:col-span-2">
              <h2 className="text-lg font-bold text-slate-900 mb-4">Disponibilidad</h2>
              {editMode ? (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"].map((dia) => (
                    <label key={dia} className="flex items-center space-x-3 px-4 py-3 bg-slate-50 hover:bg-slate-100 rounded-xl cursor-pointer transition-colors border border-slate-200">
                      <input
                        type="checkbox"
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.disponibilidad && profile.disponibilidad.length > 0 ? (
                    profile.disponibilidad.map((dia) => (
                      <span key={dia} className="px-4 py-2 bg-emerald-50 text-emerald-700 rounded-xl text-sm font-semibold border border-emerald-200">
                        {dia}
                      </span>
                    ))
                  ) : (
                    <p className="text-slate-500">No especificada</p>
                  )}
                </div>
              )}
            </div>
          ...
          <>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="text-lg font-bold text-slate-900">Información del Club</h2>
              </div>
              <div className="space-y-5">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg">{profile.nombre_club}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg flex items-center">
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-slate-900 font-medium text-lg">{profile.categoria}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
              <h2 className="text-lg font-bold text-slate-900 mb-4">Sobre el Club</h2>
              {editMode ? (
                <textarea
                  value={descripcion}
                ...
                <p className="text-slate-700 leading-relaxed">{profile.descripcion || "No especificada"}</p>
              )}
            </div>
            ...
            {!editMode && (
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <h2 className="text-lg font-bold text-slate-900 mb-4">Verificación del Club</h2>
